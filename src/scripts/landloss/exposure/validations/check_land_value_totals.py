...
column full of zeroes.
    ...
    uv run --frozen python src/scripts/landloss/exposure/validations/check_land_value_totals.py
...
# Repo root, from src/scripts/landloss/exposure/validations/ -- five levels up.
...
STEP_COMMAND = (
    ...
    "src/scripts/landloss/exposure/steps/s2_land_value/s4_estimate_land_value.py"
)
